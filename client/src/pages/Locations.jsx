...
import goMap from '../assets/go-map.svg'
    ...
    return (
        <div className='available-locations'>
            <div id='venue1button' className='venue1-button-overlay'>
                <Link to='/beacon-park' role='button'>{venueNames.venue1}</Link>
            </div>

            <div id='venue2button' className='venue2-button-overlay'>
                <Link to='/raid-plaza' role='button'>{venueNames.venue2}</Link>
            </div>

            <div id='venue3button' className='venue3-button-overlay'>
                <Link to='/lure-lagoon' role='button'>{venueNames.venue3}</Link>
            </div>

            <div id='venue4button' className='venue4-button-overlay'>
                <Link to='/hatchery-station' role='button'>{venueNames.venue4}</Link>
            </div>

            <h2 className='map-title'>Choose a meetup zone</h2>
            ...
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1000.32 500" xmlSpace="preserve">
                <image id="background" xlinkHref={goMap} width="1000" height="500"></image>
                
                <a href='/beacon-park'><polygon id="venue1" points="2.97,234.52 17.94,198.9 34.45,188.58 52.52,191.68 56.65,196.32 69.03,162.26 84,137.48 
                ...
                <a href='/raid-plaza'><polygon id="venue2" name='venue2' value={2} points="358.58,353.74 376.65,322.77 389.55,314.52 384.39,280.45 407.61,272.19 422.06,220.58 
                ...
                <a href='/lure-lagoon'><polygon id="venue3" name='venue3' value={3} points="998.06,83.81 952.65,31.16 914.45,16.71 877.29,43.55 833.94,102.39 811.74,161.23 
                796.77,241.23 802.97,303.16 833.94,353.23 871.61,385.23 954.71,385.23 1000.32,387.81 " /></a>

                <a href='/hatchery-station'><polygon id="venue4" name='venue4' value={4} points="625,291 615,305 608,318 625,338 637,354 622.5,358 673,363.5 751,363.5 793,363.5 
